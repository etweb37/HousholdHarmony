          ...
          switchBase: {
            '&.MuiSwitch-colorPrimary': {
              ...
              '&.Mui-checked': {
                color: 'rgba(208, 207, 246, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(208, 207, 246, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorSecondary': {
              ...
              '&.Mui-checked': {
                color: 'rgba(194, 238, 252, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(205, 232, 252, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorError': {
              ...
              '&.Mui-checked': {
                color: 'rgba(249, 206, 219, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(249, 206, 219, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorWarning': {
              ...
              '&.Mui-checked': {
                color: 'rgba(251, 220, 191, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(251, 220, 191, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorSuccess': {
              ...
              '&.Mui-checked': {
                color: 'rgba(205, 239, 208, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(205, 239, 208, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorInfo': {
