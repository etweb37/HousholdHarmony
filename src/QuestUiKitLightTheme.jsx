          ...
          switchBase: {
            '&.MuiSwitch-colorPrimary': {
              ...
              '&.Mui-checked': {
                color: 'rgba(107, 104, 255, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(107, 104, 255, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorSecondary': {
              ...
              '&.Mui-checked': {
                color: 'rgba(38, 196, 246, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(38, 196, 246, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorError': {
              ...
              '&.Mui-checked': {
                color: 'rgba(233, 78, 124, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(233, 78, 124, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorWarning': {
              ...
              '&.Mui-checked': {
                color: 'rgba(247, 153, 66, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(245, 161, 83, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorSuccess': {
              ...
              '&.Mui-checked': {
                color: 'rgba(85, 200, 97, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(100, 207, 111, 0.3)',
                },
              },
            },
            '&.MuiSwitch-colorInfo': {
              ...
              '&.Mui-checked': {
                color: 'rgba(79, 177, 249, 1)',
                '&:hover': {
                  backgroundColor: 'rgba(83, 177, 245, 0.3)',
                },
              },
            },
          },
