...
import { Recommend1Props } from 'src/types';

const Recommend11: any = styled('div')({
  borderRadius: `0px`,
  display: `flex`,
  position: `relative`,
  isolation: `isolate`,
...
const Recomend11: any = styled(Recomend1)(({ theme }: any) => ({
  flex: `1`,
  margin: `0px`,
}));

const Recomend12: any = styled(Recomend1)(({ theme }: any) => ({
  flex: `1`,
  margin: `0px 0px 0px 20px`,
}));

const Recomend13: any = styled(Recomend1)(({ theme }: any) => ({
  flex: `1`,
  margin: `0px 0px 0px 20px`,
}));

function Recommend1(props: Recommend1Props): JSX.Element {
  return (
