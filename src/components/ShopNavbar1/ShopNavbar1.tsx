...
import { ShopNavbar1Props } from 'src/types';
import useShopNavbar1 from 'src/components/ShopNavbar1/useShopNavbar1';

const ScreenDesktopTypeQue: any = styled('div', {
...
const SqueezLogo: any = styled('img')({
  height: `48px`,
  width: `119.64px`,
  margin: `0px`,
});
...
const IconMenu2: any = styled('div')({
  borderRadius: `0px`,
  display: `flex`,
  position: `relative`,
  isolation: `isolate`,
...
const IconSearch: any = styled('div')({
  borderRadius: `0px`,
  display: `flex`,
  position: `relative`,
  isolation: `isolate`,
...
const IconCart1: any = styled('div')({
  borderRadius: `0px`,
  display: `flex`,
  position: `relative`,
  isolation: `isolate`,
...
function ShopNavbar1(props: ShopNavbar1Props): JSX.Element {
